        ...
        <div class="offcanvas-body">
            <div class="order-md-last">
                ...
                <form role="search" action="{{ route('search') }}" method="GET" class="d-flex mt-3 gap-0">
                    <input class="form-control rounded-start rounded-0 bg-light" type="text" name="search"
                        placeholder="Apa yang sedang Anda cari?" aria-label="Apa yang sedang Anda cari?">
                ...
                <div class="col-sm-6 offset-sm-2 offset-md-0 col-lg-5 d-none d-lg-block">
                    <div class="search-bar row bg-light p-2 my-2 rounded-4">
                        ...
                        <div class="col-11 col-md-7">
                            <form id="search-form" class="text-center" action="{{ route('search') }}"
                                method="GET">
                        ...
                        <div class="col-1">
                            <svg id="search-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24">
                                <path fill="currentColor"
                                    d="M21.71 20.29L18 16.61A9 9 0 1 0 16.61 18l3.68 3.68a1 1 0 0 0 1.42 0a1 1 0 0 0 0-1.39ZM11 18a7 7 0 1 1 7-7a7 7 0 0 1-7 7Z" />
                            </svg>
                ...
                <div
                    ...
                    <div class="menu">
                        @auth <!-- Memeriksa apakah pengguna sudah masuk -->
                            <div class="dropdown">
                                <a class="dropdown-toggle" href="#" role="button" id="user-menu-toggle"
                                    ...
                                    <div class="swiper-slide">
                                        <div class="row banner-content p-5">
                                            <div class="content-wrapper col-md-7">
                                                ...
                                                <a href="https://tokopedia.link/tqozEIjrsIb"
                                        ...
                                        <div class="row banner-content p-5">
                                            <div class="content-wrapper col-md-7">
                                                ...
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Dignissim
                                                    massa diam elementum.</p>
                                                <a href="https://tokopedia.link/tqozEIjrsIb"
                                                    class="btn btn-outline-dark btn-lg text-uppercase fs-6 rounded-1">Shop</a>
                                            </div>
                                            <div class="img-wrapper col-md-5">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="row banner-content p-5">
                                            <div class="content-wrapper col-md-7">
                                                ...
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Dignissim
                                                    massa diam elementum.</p>
                                                <a href="https://tokopedia.link/SJKfiosrsIb"
                                                    class="btn btn-outline-dark btn-lg text-uppercase fs-6 rounded-1">Shop</a>
                                            </div>
                                            <div class="img-wrapper col-md-5">
                        ...
                        <div class="banner-ad bg-success-subtle block-2"
                            ...
                            <div class="row banner-content p-5">
                                ...
                                <div class="content-wrapper col-md-7">
                                    ...
                                    <a href="https://tokopedia.link/jT5cQcyrsIb"
                                        class="d-flex align-items-center nav-link">Shop Collection <svg width="24"
                                            height="24">
                        ...
                        <div class="banner-ad bg-danger block-3"
                            ...
                            <div class="row banner-content p-5">
                                ...
                                <div class="content-wrapper col-md-7">
                                    ...
                                    <a href="https://tokopedia.link/zKRMWLursIb"
                                        class="d-flex align-items-center nav-link">Shop Collection <svg width="24"
                                            height="24">
                                            <use xlink:href="#arrow-right"></use>
                                        </svg></a>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="category-carousel swiper">
                        <div class="swiper-wrapper">
                            <a href="{{ route('search', ['search' => 'T-Shirt']) }}"
                                            ...
                                            @foreach ($products as $product)
                                                <div class="col">
                                                    <div class="product-item">
                                                        <span
                                                            class="badge bg-success position-absolute m-3">-30%</span>
                                        ...
                                        <div
                                                ...
                                                <div class="product-item">
                                                    ...
                                                    <figure>
                                                        <a href="single-product.html" title="Product Title">
                                                            <img src="assets/images/thumb-cucumber.png"
                                                                class="tab-image">
                                                        </a>
                                                    </figure>
                                            ...
                                            <div class="col">
                                                <div class="product-item">
                                                    ...
                                                    <figure>
                                                        <a href="single-product.html" title="Product Title">
                                                            <img src="assets/images/thumb-orange-juice.png"
                                                                class="tab-image">
                                                        </a>
                                                    </figure>
                                                    <h3>Sunstar Fresh Melon Juice</h3>
                                            ...
                                            <div class="col">
                                                <div class="product-item">
                                                    ...
                                                    <figure>
                                                        <a href="single-product.html" title="Product Title">
                                                            <img src="assets/images/thumb-raspberries.png"
                                                                class="tab-image">
                                                        </a>
                                                    </figure>
                                                    <h3>Sunstar Fresh Melon Juice</h3>
                                            ...
                                            <div class="col">
                                                <div class="product-item">
                                                    ...
                                                    <figure>
                                                        <a href="single-product.html" title="Product Title">
                                                            <img src="assets/images/thumb-bananas.png"
                                                                class="tab-image">
                                                        </a>
                                                    </figure>
                                                    <h3>Sunstar Fresh Melon Juice</h3>
                                        ...
                                        <div
                                            ...
                                            <div class="col">
                                                <div class="product-item">
                                                    ...
                                                    <figure>
                                                        <a href="single-product.html" title="Product Title">
                                                            <img src="assets/images/thumb-tomatoes.png"
                                                                class="tab-image">
                                                        </a>
                                                    </figure>
                                                    <h3>Sunstar Fresh Melon Juice</h3>
                                            ...
                                            <div class="col">
                                                <div class="product-item">
                                                    ...
                                                    <figure>
                                                        <a href="single-product.html" title="Product Title">
                                                            <img src="assets/images/thumb-tomatoketchup.png"
                                                                class="tab-image">
                                                        </a>
                                                    </figure>
                                                    <h3>Sunstar Fresh Melon Juice</h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="banner-ad bg-danger mb-3"
                                style="background: url('assets/images/ad-image-3.png');background-repeat: no-repeat;background-position: right bottom;">
                        ...
                        <div class="col-md-6">
                            <div class="banner-ad bg-info"
                                style="background: url('assets/images/ad-image-4.png');background-repeat: no-repeat;background-position: right bottom;">
                                <div class="banner-content p-5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <div class="card-body p-0">
                                            <h5>Free delivery</h5>
                                            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipi elit.
                                            </p>
                                        </div>
                                    </div>
                                </div>
